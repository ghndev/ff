    ...
    <div className="bg-[#080808] h-16">
      <MaxWidthWrapper>
        <div className="flex items-center justify-between h-full">
          ...
          <Link href="watchlist" className="text-custom-gray flex items-center">
            <Bookmark className="h-6 w-6 fill-custom-gray mr-1" /> Watchlist
          </Link>

          <Link href="sign-in" className="text-custom-gray flex items-center">
            <svg
              width="24"
              height="25"
              viewBox="0 0 24 25"
              ...
              <g clip-path="url(#clip0_2042_2085)">
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
